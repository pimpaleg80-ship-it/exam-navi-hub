...
export const EXAMS: Exam[] = [
  {
    ...
    dates: [
      { event_type: "notification_released", label: "Information Bulletin out", start_datetime: d(2026, 10, 28) },
      { event_type: "registration_open", label: "Session 1 registration opens", start_datetime: d(2026, 10, 28) },
      { event_type: "registration_close", label: "Session 1 registration closes", start_datetime: d(2026, 11, 25, 23, 50) },
      { event_type: "correction_window", label: "Correction window", start_datetime: d(2026, 11, 28), end_datetime: d(2026, 11, 30, 23, 50) },
      { event_type: "city_slip", label: "City intimation slip", start_datetime: d(2026, 12, 20), is_tentative: true },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 1, 15), is_tentative: true },
      { event_type: "exam_date", label: "Session 1 exam window", start_datetime: d(2027, 1, 22), end_datetime: d(2027, 1, 30) },
      { event_type: "answer_key", label: "Provisional answer key & challenge", start_datetime: d(2027, 2, 4), end_datetime: d(2027, 2, 6), is_tentative: true },
      { event_type: "result", label: "Session 1 result", start_datetime: d(2027, 2, 12), is_tentative: true },
    ],
  },
  {
    slug: "jee-advanced",
    ...
    dates: [
      { event_type: "registration_open", label: "Registration opens", start_datetime: d(2027, 4, 23) },
      { event_type: "registration_close", label: "Registration closes", start_datetime: d(2027, 5, 2, 17, 0) },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 5, 11), is_tentative: true },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 5, 18, 9, 0) },
      { event_type: "result", label: "Result declaration", start_datetime: d(2027, 6, 8), is_tentative: true },
    ],
  },
  {
    slug: "bitsat",
    ...
    dates: [
      { event_type: "registration_open", label: "Registration opens", start_datetime: d(2027, 1, 15) },
      { event_type: "registration_close", label: "Registration closes", start_datetime: d(2027, 3, 20, 23, 50) },
      { event_type: "admit_card", label: "Hall ticket release", start_datetime: d(2027, 5, 5), is_tentative: true },
      { event_type: "exam_date", label: "Session 1 exam window", start_datetime: d(2027, 5, 21), end_datetime: d(2027, 5, 26) },
    ],
  },
  {
    slug: "viteee",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2026, 11, 5) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 3, 31, 23, 50) },
      { event_type: "exam_date", label: "Exam window", start_datetime: d(2027, 4, 19), end_datetime: d(2027, 4, 27), is_tentative: true },
    ],
  },
  {
    slug: "srmjeee",
    ...
    dates: [
      { event_type: "registration_open", label: "Phase 1 registration opens", start_datetime: d(2026, 11, 1) },
      { event_type: "registration_close", label: "Phase 1 registration closes", start_datetime: d(2027, 3, 30, 23, 50) },
      { event_type: "exam_date", label: "Phase 1 exam", start_datetime: d(2027, 4, 10), end_datetime: d(2027, 4, 12), is_tentative: true },
    ],
  },
  {
    slug: "met",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2026, 10, 20) },
      { event_type: "registration_close", label: "Phase 1 closes", start_datetime: d(2027, 3, 15, 23, 50) },
      { event_type: "exam_date", label: "Phase 1 exam", start_datetime: d(2027, 4, 5), is_tentative: true },
    ],
  },
  {
    slug: "aeee",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2026, 10, 15) },
      { event_type: "registration_close", label: "Phase 1 closes", start_datetime: d(2027, 2, 28, 23, 50) },
      { event_type: "exam_date", label: "Phase 1 exam", start_datetime: d(2027, 3, 20), is_tentative: true },
    ],
  },
  {
    slug: "neet-ug",
    ...
    dates: [
      { event_type: "notification_released", label: "Information Bulletin out", start_datetime: d(2027, 2, 5) },
      { event_type: "registration_open", label: "Registration opens", start_datetime: d(2027, 2, 5) },
      { event_type: "registration_close", label: "Registration closes", start_datetime: d(2027, 3, 7, 23, 50) },
      { event_type: "correction_window", label: "Correction window", start_datetime: d(2027, 3, 10), end_datetime: d(2027, 3, 12, 23, 50) },
      { event_type: "city_slip", label: "City intimation slip", start_datetime: d(2027, 4, 20), is_tentative: true },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 4, 30), is_tentative: true },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 5, 2, 14, 0) },
      { event_type: "answer_key", label: "Provisional answer key & challenge", start_datetime: d(2027, 5, 28), end_datetime: d(2027, 5, 30), is_tentative: true },
      { event_type: "result", label: "Result declaration", start_datetime: d(2027, 6, 14), is_tentative: true },
      { event_type: "counseling", label: "MCC counseling registration", start_datetime: d(2027, 7, 15), is_tentative: true },
    ],
  },
  {
    slug: "icar-aieea-ug",
    ...
    eligibility_summary: "Class 12 with PCB / PCM / Agriculture for UG agriculture and allied degrees.",
    ...
    dates: [
      { event_type: "registration_open", label: "Registration opens", start_datetime: d(2027, 3, 10) },
      { event_type: "registration_close", label: "Registration closes", start_datetime: d(2027, 4, 12, 23, 50) },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 6, 5), is_tentative: true },
    ],
  },
  {
    ...
    dates: [
      { event_type: "registration_open", label: "Registration opens", start_datetime: d(2027, 3, 20) },
      { event_type: "registration_close", label: "Registration closes", start_datetime: d(2027, 4, 20, 17, 0) },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 5, 25), is_tentative: true },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 6, 8), is_tentative: true },
    ],
  },
  {
    slug: "nda-na",
    ...
    pattern: "OMR · Maths 300 + GAT 600 marks · +ve/-ve marking · followed by SSB interview (900 marks)",
    fees: [
      { category_label: "General / OBC", amount: 100 },
      { category_label: "SC / ST / Sons of JCOs", amount: 0 },
    ],
    dates: [
      { event_type: "notification_released", label: "NDA-I notification", start_datetime: d(2026, 12, 10) },
      { event_type: "registration_open", label: "NDA-I registration opens", start_datetime: d(2026, 12, 10) },
      { event_type: "registration_close", label: "NDA-I registration closes", start_datetime: d(2026, 12, 30, 18, 0) },
      { event_type: "admit_card", label: "e-Admit card", start_datetime: d(2027, 3, 25), is_tentative: true },
      { event_type: "exam_date", label: "NDA-I written exam", start_datetime: d(2027, 4, 11, 10, 0) },
      { event_type: "registration_open", label: "NDA-II registration opens", start_datetime: d(2027, 5, 19) },
      { event_type: "registration_close", label: "NDA-II registration closes", start_datetime: d(2027, 6, 8, 18, 0) },
    ],
  },
  {
    slug: "army-tes",
    ...
    dates: [
      { event_type: "registration_open", label: "Online application opens", start_datetime: d(2027, 5, 15) },
      { event_type: "registration_close", label: "Online application closes", start_datetime: d(2027, 6, 13, 23, 50) },
      { event_type: "result", label: "SSB shortlist published", start_datetime: d(2027, 7, 20), is_tentative: true },
    ],
  },
  {
    slug: "afcat",
    ...
    dates: [
      { event_type: "registration_open", label: "AFCAT 01 registration opens", start_datetime: d(2026, 12, 1) },
      { event_type: "registration_close", label: "AFCAT 01 registration closes", start_datetime: d(2026, 12, 30, 23, 30) },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 1, 25), is_tentative: true },
      { event_type: "exam_date", label: "AFCAT 01 exam", start_datetime: d(2027, 2, 12), end_datetime: d(2027, 2, 14) },
    ],
  },
  {
    slug: "iiser-iat",
    ...
    eligibility_summary: "Class 12 in science stream in the last two years; single national aptitude test for all IISERs.",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 4, 1) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 5, 10, 23, 50) },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 5, 22), is_tentative: true },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 5, 31, 9, 0), is_tentative: true },
    ],
  },
  {
    slug: "nest",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 2, 20) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 5, 5, 23, 50) },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 6, 21, 9, 0), is_tentative: true },
    ],
  },
  {
    ...
    eligibility_summary: "Class 12 with Mathematics and English; B.Stat (Hons) and B.Math (Hons) entry.",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 2, 1) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 3, 5, 23, 50) },
      { event_type: "exam_date", label: "Written test", start_datetime: d(2027, 5, 9, 10, 0), is_tentative: true },
    ],
  },
  {
    slug: "cmi-entrance",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 3, 1) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 4, 15, 23, 50) },
      { event_type: "exam_date", label: "Entrance exam", start_datetime: d(2027, 5, 16, 13, 0), is_tentative: true },
    ],
  },
  {
    slug: "mht-cet",
    ...
    eligibility_summary: "Maharashtra domicile preferred; PCM group for engineering, PCB group for pharmacy/agri.",
    ...
    dates: [
      { event_type: "registration_open", label: "Registration opens", start_datetime: d(2026, 12, 26) },
      { event_type: "registration_close", label: "Registration closes", start_datetime: d(2027, 2, 15, 23, 50) },
      { event_type: "late_fee_close", label: "Late fee window closes", start_datetime: d(2027, 2, 22, 23, 50) },
      { event_type: "admit_card", label: "Hall ticket release", start_datetime: d(2027, 4, 5), is_tentative: true },
      { event_type: "exam_date", label: "PCM group exam window", start_datetime: d(2027, 4, 16), end_datetime: d(2027, 4, 25) },
    ],
  },
  {
    slug: "kcet",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 1, 20) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 2, 20, 23, 50) },
      { event_type: "admit_card", label: "Admit card release", start_datetime: d(2027, 4, 1), is_tentative: true },
      { event_type: "exam_date", label: "Exam days", start_datetime: d(2027, 4, 15), end_datetime: d(2027, 4, 16) },
    ],
  },
  {
    slug: "comedk-uget",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 1, 10) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 4, 5, 23, 50) },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 5, 9, 9, 0), is_tentative: true },
    ],
  },
  {
    slug: "wbjee",
    ...
    eligibility_summary: "Class 12 with Physics & Mathematics plus one of Chemistry/Biology/Biotech/CS.",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2026, 12, 20) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 1, 20, 23, 50) },
      { event_type: "correction_window", label: "Correction window", start_datetime: d(2027, 1, 23), end_datetime: d(2027, 1, 26) },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 4, 25, 11, 0), is_tentative: true },
    ],
  },
  {
    slug: "ts-eapcet",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 2, 1) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 3, 20, 23, 50) },
      { event_type: "late_fee_close", label: "Late fee window closes", start_datetime: d(2027, 4, 5, 23, 50) },
      { event_type: "exam_date", label: "Engineering stream exam", start_datetime: d(2027, 5, 4), end_datetime: d(2027, 5, 8), is_tentative: true },
    ],
  },
  {
    slug: "ap-eapcet",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 2, 10) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 3, 28, 23, 50) },
      { event_type: "exam_date", label: "Exam window", start_datetime: d(2027, 5, 12), end_datetime: d(2027, 5, 18), is_tentative: true },
    ],
  },
  {
    slug: "keam",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 2, 5) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 3, 10, 23, 50) },
      { event_type: "exam_date", label: "Exam window", start_datetime: d(2027, 4, 22), end_datetime: d(2027, 4, 28), is_tentative: true },
    ],
  },
  {
    slug: "gujcet",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2026, 12, 15) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 1, 15, 23, 50) },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 3, 28, 10, 0), is_tentative: true },
    ],
  },
  {
    slug: "ojee",
    ...
    eligibility_summary: "Odisha domicile for state quota; pharmacy and allied UG courses post-12th.",
    min_percentage: "45% in PCM / PCB (40% reserved)",
    age_limit: "No upper age limit",
    pattern: "CBT · course-specific papers · +4 / -1",
    fees: [{ category_label: "All categories", amount: 1000 }],
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 1, 25) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 3, 15, 23, 50) },
      { event_type: "exam_date", label: "Exam window", start_datetime: d(2027, 5, 6), end_datetime: d(2027, 5, 10), is_tentative: true },
    ],
  },
  {
    slug: "bcece",
    ...
    eligibility_summary: "Bihar domicile; agriculture and allied UG streams (PCB / PCM / PCMB groups).",
    min_percentage: "45% in group subjects (40% reserved)",
    ...
    dates: [
      { event_type: "registration_open", label: "Application opens", start_datetime: d(2027, 3, 5) },
      { event_type: "registration_close", label: "Application closes", start_datetime: d(2027, 4, 10, 23, 50) },
      { event_type: "exam_date", label: "Exam day", start_datetime: d(2027, 5, 30), is_tentative: true },
    ],
  },
];
